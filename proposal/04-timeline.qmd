...
Implementation of most (if not all) routines available for `nalgebra` arrays in Rust, including transformations, decompositions, and algebraic operations between matrices. Ideally this implementation would support and facilitate easy addition of new methods added in future versions of `nalgebra`.

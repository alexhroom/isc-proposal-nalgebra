...
-->
We are assuming that there is desire among the communities whose data analysis depends heavily on linear algebra desire to use R, and that authors of Rust data analysis packages are interested in having R bindings. 
